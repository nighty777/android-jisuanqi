...
public class Jisuanqi extends Activity
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        button2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                第二个参数:目标文件
                 */
                Intent intent = new Intent(Jisuanqi.this,Convert.class);
        ...
        button5.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Jisuanqi.this,"更多内容请联系qq：1250973679",Toast.LENGTH_LONG).show();
            }
        });
        ...
        button3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent t2=new Intent(Jisuanqi.this,Unit.class);
                startActivity(t2);
            }
        });
        ...
        //进制转换
        button2.setOnClickListener(actionPerformed);
        //单位换算
        //为+-x÷等按键绑定监听器
    ...
    {
        Toast.makeText(this,"更多内容请联系qq：1250973679",Toast.LENGTH_LONG).show();
    }
    /*
     * 键盘命令捕捉
     */
    ...
    private OnClickListener actionPerformed = new OnClickListener() {
        public void onClick(View v) {
            ...
            if("0123456789.()sincostanlnlogn!+-×÷√^".indexOf(command) != -1
                ...
                tip.setText("欢迎使用！");
                //如果输入的是清除键
            } else if(command.compareTo("清屏") == 0) {
                //将显示器内容设置为0
                input.setText("0");
                //重新输入标志置为true
                vbegin = true;
            ...
            else if(command.compareTo("进制转换")==0)
            {
                jumpToConvert();
            }
            else if(command.compareTo("单位换算")==0)
            {
    ...
    private  void jumpToConvert(){
        Intent it1=new Intent(Jisuanqi.this,Convert.class);
        startActivity(it1);
    }
}